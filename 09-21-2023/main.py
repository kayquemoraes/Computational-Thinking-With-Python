...
querystring = {"q":"São Paulo"}

headers = {
	"X-RapidAPI-Key": "3b15060171msh4ba6faa6a909b92p15c9a8jsn426893ed1780",
...
print(response.json())
'''
def traduzir(lingua_alvo,texto,lingua_origem = 'pt'):
	url = "https://text-translator2.p.rapidapi.com/translate"

	payload = {
		"source_language": lingua_origem,
		"target_language": lingua_alvo,
		"text": texto
	}
	headers = {
...
for lingua in lista:
	...
	if nome == "English":
		continue
	nome_certo = traduzir(codigo,nome,'en')
	dic_novo[nome_certo] = codigo
print(dic_novo)
lingua_origem = forca_opcao("Em que lingua está o texto ? ",dic_novo.keys())
lingua_destino = forca_opcao("Diga a lingua para a qual traduzir : ",dic_novo.keys())
texto = input("Me diga o texto a ser traduzido : ")
traduzido = traduzir(dic_novo[lingua_destino],texto)
print(traduzido)